...
/// [MySlider] uses this callback to paint the value indicator on the overlay.
///
...
///
/// {@tool dartpad}
/// This sample shows the creation of a [MySlider] using [ThemeData.useMaterial3] flag,
...
///
/// {@tool dartpad}
/// This example shows a [MySlider] widget using the [MySlider.secondaryTrackValue]
...
class MySlider extends StatefulWidget {
  ...
  /// Creates an adaptive [MySlider] based on the target platform, following
  /// Material design's
  ...
  ///
  /// If not null, a secondary track using [MySlider.secondaryActiveColor] color
  /// is drawn between the thumb and this value, over the inactive track.
  ///
  /// If less than [MySlider.value], then the secondary track is not shown.
  ///
  /// It can be ideal for media scenarios such as showing the buffering progress
  /// while the [MySlider.value] shows the play progress.
  ...
  /// the [MySlider.secondaryTrackValue].
  ///
  ...
  ///
  /// If this color is null, [MySlider] will use [activeColor], If [activeColor]
  /// is also null, [MySlider] will use [SliderThemeData.thumbColor].
  ///
  ...
  ///
  /// If this property is null, [MySlider] will use [activeColor] with
