...
///
/// Used by [MyDropdownButton.selectedItemBuilder].
...
/// An item in a menu created by a [MyDropdownButton].
///
...
class DropdownMenuItem<T> extends _DropdownMenuItemContainer {
  ...
  ///
  /// Eventually returned in a call to [MyDropdownButton.onChanged].
  final T? value;
...
/// [MyDropdownButton] widgets placed within material data tables, as
...
class DropdownButtonHideUnderline extends InheritedWidget {
  ...
  /// Returns whether the underline of [MyDropdownButton] widgets should
  /// be hidden.
...
///
/// {@tool dartpad}
/// This sample shows a [MyDropdownButton] with a large arrow icon,
...
class MyDropdownButton<T> extends StatefulWidget {
  ...
  ///
  /// If the [onChanged] callback is null or the list of [MyDropdownButton.items]
  /// is null then the dropdown button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  /// will display the [MyDropdownButton.disabledHint] widget if it is non-null.
  /// If [MyDropdownButton.disabledHint] is also null but [MyDropdownButton.hint] is
  /// non-null, [MyDropdownButton.hint] will instead be displayed.
  /// {@endtemplate}
  ...
  ///
  /// As the padding increases, the size of the [MyDropdownButton] will also
